...
/**
 * This class encapsulates a print job comprising job id, name of job owner, and
 * name of file to be printed. It is only visible within its package.
 * 
...
class Job {
	...
	/**
	 * Initializes a job instance with job id, name of owner, name of file to be
	 * printed.
	 * 
...
/**
 * This class encapsulates a print job with a specialization of the equality
 * condition, in that two OwnerJob instances are equal if their owner names are
 * the same.
 * 
 * @author Sesh Venugopal
 *
...
class OwnerJob extends Job {
	...
	/**
	 * Initializes an owner job instance with job id, name of owner, name of file to
	 * be printed.
	 * 
...
/**
 * This class encapsulates a print job with a specialization of the equality
 * condition, in that two IdOwnerJob instances are equal if their ids and owner
 * names are the same.
 * 
 * @author Sesh Venugopal
 *
...
class IdOwnerJob extends Job {
	...
	/**
	 * Initializes an IdOwner job instance with job id, name of owner, name of file
	 * to be printed.
	 * 
	 * @param owner    Name of job owner.
	 * @param jobId    Id of job.
