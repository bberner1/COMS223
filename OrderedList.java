...
public class OrderedList<T extends Comparable<T>> {
	 ...
	 * @throws OrderViolationException If the last item in the list is greater or
	 ...
	 * @throws IndexOutOfBoundsException If the given position is < 0 or >= list
	 *                                   size.
	 * @throws OrderViolationException   If the item in the list that would precede
	 *                                   the new item is >= the new item, or the
	 *                                   item in th list that would succeed the new
	 ...
	 * @throws OrderViolationException If the new item is a duplicate of an existing
	 *                                 item.
	 */
	...
	/**
	 * Searches for a given item in this list using binary search, and returns the
	...
	/**
	 * Returns the next item in this list, relative to a previous call to first or
	 * next.
	 * 
